    ...
    */
    ...
    function update( delta ) {
        ...
        if ( ( input.moveKeys.length > 0 ) &&
            ...
            // --- GTA CAMERA ADDITION ---
            // Calculate direction relative to camera yaw
            let camYaw = (typeof cameraControl !== 'undefined') ? cameraControl.getYaw() : 0;
            let targetDirection = utils.toPiRange( requestedDirection + camYaw );

            if ( currentDirection != targetDirection ) {

                // get the difference in radians between the current orientation
                // and the requested one
                angleToApply = utils.toPiRange( targetDirection - currentDirection ) ;
                ...
                if ( angleToApply < 0.01 && angleToApply > -0.01 ) {
                    ...
                    HORIZMOVEVECT.applyAxisAngle( AXISHORIZMOVEROT, currentDirection );
